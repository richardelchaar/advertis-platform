...
def seed_database():
    ...
    if product_collection.count() == 0:
        ...
        products_to_seed = [
            {
                "id": "alienware_monitor",
                "document": "A high-performance Alienware curved gaming monitor, perfect for immersive cyberpunk experiences.",
                "metadata": {
                    # --- Universal Metadata ---
            ...
            {
                "id": "red_bull",
                "document": "A can of Red Bull energy drink, it gives you wings and focus for long nights of hacking.",
                "metadata": {
                    "name": "Red Bull",
                    "brand": "Red Bull",
                    "target_vertical": "gaming",
            ...
            {
                "id": "omni-corp_implants",
                "document": "Advanced cybernetic implants from the fictional Omni-Corp, known for enhancing human abilities.",
                "metadata": {
                    "name": "Omni-Corp Cybernetics",
                    "brand": "Omni-Corp",
                    "target_vertical": "gaming",
                    "vertical_specific_attributes": {
                        "type": "lore",
